...
import { decreseQuantity, increseQuantity, removeCartItem } from '../../feature/cartSlice';
      ...
      <div className="w-full flex items-center justify-between py-1">
        <div className="flex">
          <button
            ...
            className={`${item.quantity === 1 && 'opacity-70 cursor-not-allowed' } w-9 h-7 rounded-md
          ...
          <button
            ...
            className={
              ...
              `${item.quantity === item.inStock && 'opacity-70 cursor-not-allowed' }
              w-9 h-7 rounded-md
