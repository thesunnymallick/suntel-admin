...
import { addMultipleToCart, addToCart } from "../../feature/cartSlice";
...
const ProductInfo = () => {
  ...
  // Initial data for the product table
  ...
  const rowSelection = {
    ...
    getCheckboxProps: (record) => ({
      disabled:
        record.inStock === 0 ||
        cartItems.some((item) => item.key === record.key),
    }),
  };
